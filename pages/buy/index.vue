      ...
      <div class="buy-details">
          ...
          <div class="buy-details-content">
            <div class="buy-details-item">
              ...
              <span
                ...
                class="Roboto-Medium buy-details-item-value"
              >
                {{ selectedProvider }}
              </span>
              <span v-else>Ödeme kanalı seçiniz</span>
            </div>
            <div class="buy-details-item">
              <span class="Roboto-Regular buy-details-item-label">
                {{ $t('buy_total') }}
              ...
              <span class="Roboto-Medium buy-details-item-value">
                {{ BuyForm.FiatAmount }}&nbsp;{{ BuyForm.Fiat }}
              </span>
            </div>
            <div class="buy-details-item">
              <span class="Roboto-Regular buy-details-item-label">
              ...
              <span
                ...
                class="Roboto-Medium buy-details-item-value"
              >
                {{ BuyTrans.GetAmount }}&nbsp;{{ BuyForm.Asset }}
              </span>
              <span class="Roboto-Medium buy-details-item-value"
                >&nbsp;-&nbsp;</span
              >
        ...
        >
          ...
          <p class="confirm-modal-text Roboto-Regular">
            {{ selectedProvider }} sağlayıcısının, bağımsız üçüncü parti
            uygulama tarafından işletilen bir itibari para ve kripto para birimi
            değişim platformu olduğunu anlıyorum. COINTRAL, bu hizmetin
            kulanımdan kaynaklanan herhangi bir kayıp veya hasardan sorumlu
            olmayacaktır.
          </p>
          <a-checkbox
      ...
      <a-col offset="1" :span="22">
        ...
        <div class="buy-details-content">
          <div class="buy-details-item">
            ...
            <span v-else class="Roboto-Medium buy-details-item-value">
              Ödeme kanalı seçiniz
            </span>
          </div>
          <!-- <div class="buy-details-item">
            <span class="Roboto-Regular buy-details-item-label">
          ...
          <div class="buy-details-item">
            ...
            <span
              v-if="selectedProvider"
              class="Roboto-Bold buy-details-item-value"
            >
              {{ BuyTrans.GetAmount }}&nbsp;{{ BuyForm.Asset }}
            </span>
            <span v-else class="Roboto-Bold buy-details-item-value">
              &nbsp;-&nbsp;
            </span>
          </div>
        </div>
        ...
        <div class="buy-actions">
          ...
          >
            ...
            <p class="confirm-modal-text Roboto-Regular">
              {{ selectedProvider }} sağlayıcısının, bağımsız üçüncü parti
              uygulama tarafından işletilen bir itibari para ve kripto para
              birimi değişim platformu olduğunu anlıyorum. COINTRAL, bu hizmetin
              kulanımdan kaynaklanan herhangi bir kayıp veya hasardan sorumlu
              olmayacaktır.
            </p>
            <a-checkbox
