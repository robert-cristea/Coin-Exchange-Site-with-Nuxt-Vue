  ...
  <div class="Roboto-Regular" style="background-color: #fafafa">
    ...
    <a-row :class="!isMobile ? 'main-row' : 'main-row-mobile'">
      ...
      >
        ...
        <a-col v-else>
          <div v-blur="isBlur">
            <BranchInfo
              :title="this.$t('fiat_wallet_text_bank')"
              :explanation="
            ...
            <BranchInfo
              :title="this.$t('fiat_wallet_text_receiver')"
              :explanation="
            ...
            <BranchInfo
              :title="this.$t('fiat_wallet_text_deposit_code')"
    ...
    <a-row :style="!isMobile ? 'margin-top: 20px; margin-bottom: 20px' : null">
      <FiatWalletHistory
        ...
        :title="this.$t(fiat_wallet_deposit_history)"
      />
