          ...
          <div class="security-links">
            ...
            >
              <a-list-item class="security-settings-list-item Roboto-Medium">
                <a-list-item-meta
                  v-bind:title="$t('security_setting_text_2fa_enable')"
                >
                  <img
              ...
              <a-list-item class="security-settings-list-item Roboto-Medium">
                <a-list-item-meta
                  v-bind:title="$t('security_setting_text_id_authenticate')"
                >
                  <img
              ...
              <a-list-item class="security-settings-list-item Roboto-Medium">
                <a-list-item-meta
                  v-bind:title="$t('security_setting_text_antiphishing')"
                >
                  <img
