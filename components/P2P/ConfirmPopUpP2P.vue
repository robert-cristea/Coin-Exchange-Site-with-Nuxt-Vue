  ...
  >
    <div v-if="RequestInfo.Step === 4" class="content">
      ...
      <h3 align="center" class="Roboto-Medium m-0">
        <span style="font-size: 16px"> Dikkat bu işlem geri alınamaz! </span>
        <br />
        <span style="margin: 5px auto; font-size: 14px">
          {{ RequestInfo.P2PRequestUsername }}
        </span>
        <br />
        <div class="Roboto-Regular" style="font-size: 14px; margin: 20px auto">
          kullanıcısından
          {{ RequestInfo.Amount }} {{ RequestInfo.Asset }} karşılığında
          {{ RequestInfo.Total }} {{ RequestInfo.FiatCurrency }} ödeme aldığımı
          onaylıyorum.
        </div>
      </h3>
    ...
    <div v-else-if="RequestInfo.Step === 8" class="content">
      ...
      <h3 align="center" class="Roboto-Medium m-0">
        ...
        {{ RequestInfo.P2PRequestUsername }} kullanıcısına
        {{ RequestInfo.Amount }} {{ RequestInfo.Asset }} karşılığında
        {{ RequestInfo.Total }} {{ RequestInfo.FiatCurrency }}, ödeme yaptığımı
        onaylıyorum.
      </h3>
      <div class="action-buttons">
        <a-button
